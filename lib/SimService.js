...
function Sim(url) {
    ...
    this.sims = function(ids, options)
    {
	var resp = json_call_ajax_sync("Sim.sims", [ids, options]);
//	var resp = json_call_sync("Sim.sims", [ids, options]);
        return resp[0];
    }

    this.sims_async = function(ids, options, _callback, _error_callback)
    {
	json_call_ajax_async("Sim.sims", [ids, options], 1, _callback, _error_callback)
    }
